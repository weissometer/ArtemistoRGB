...
// Modified by Eric Weiss 
/*
This Program attempts to deal with the Oddities of Artemis and the setup.
The BJTs are inverted.
*/
...
void loop() {
  ...
  if (lastPacket < 5000) {
   ...
   int redInverse= DMXSerial.read(5);
   int greenInverse= DMXSerial.read(6);
  int  blueInverse=DMXSerial.read(7);
